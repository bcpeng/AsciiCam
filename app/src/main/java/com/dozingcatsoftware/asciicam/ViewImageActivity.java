...
/**
 * Activity for displaying a single image. The user can delete the image, or share it in its PNG or
...
public class ViewImageActivity extends Activity {
    ...
    public void sharePicture(View view) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.shareDialogYesLabel,
    ...
    public void shareHtml() {
        ...
        String htmlPath = imageUri.getPath().substring(0, imageUri.getPath().length() - 4) +
                ".html";
